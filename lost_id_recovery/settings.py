"""
Django settings for lost_id_recovery project.
...
ALLOWED_HOSTS = ['lostid.onrender.com',]
...
ROOT_URLCONF = 'lost_id_recovery.urls'
...
WSGI_APPLICATION = 'lost_id_recovery.wsgi.application'
